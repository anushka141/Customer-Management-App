...
def customers(request, pk_test):
    ...
    return render(request, 'myapp/customers.html', context)
...
def createOrder(request, pk):
    OrderFormSet = inlineformset_factory(
        Customer, Order, fields=('products', 'status'), extra=5)
...
def updateOrder(request, pk):
    ...
    context = {'form': form}
    return render(request, 'myapp/update_order_form.html', context)
